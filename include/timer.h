...
class Timer : public QObject {
   ...
   private:
    ...
    std::chrono::system_clock::time_point startTimeDB, roundFinishTimeDB,
        finishTime;
    ...
    const char* sqlLaunches =
        "CREATE TABLE IF NOT EXISTS launches ("
        "launch_id INTEGER PRIMARY KEY, "
        "start_time INTEGER, "
        "finish_time INTEGER);";

    const char* sqlRounds =
